...
$(document).ready(function() {
	...
	$.getJSON('services.json', function(data) {
		...
		$.each(data, function(key, value) {
			options += '<option value="' + value.value + '" data-price="' + value.price + '">' + value.label + ' - ₹' + value.price + '</option>';
		});
		...
		// Function to update total price based on selected services
		...
		// Initial call to calculate total price
		updateTotalPrice();
	});

	// Form submission (just a placeholder, adjust as per your backend needs)
	$('#appointment-form').submit(function(e) {
		e.preventDefault();
		alert('Form submitted! Implement your form submission logic here.');
	});
});